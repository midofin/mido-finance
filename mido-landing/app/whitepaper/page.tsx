        ...
        <main className="container mx-auto px-4 py-16">
          ...
          <Section title="Roadmap">
            <div className="relative">
              {/* Adjust the position and width to prevent overflow */}
              <div className="hidden md:block border-l-4 border-green-400 absolute h-full left-1/2 transform -translate-x-1/2" />
              <RoadmapItem
